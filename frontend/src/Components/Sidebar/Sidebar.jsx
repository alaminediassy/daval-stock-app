    ...
    <div>
        ...
        <div className="px-3 py-3 lg:px-5 lg:pl-3">
            ...
            <div className="flex items-center justify-start">
                ...
                <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Daval Stock</span>
                </a>
            </div>
            <div className="flex items-center">
                <div className="flex items-center ml-3">
                    ...
                    <ul className="py-1" role="none">
                        <li>
                        <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Dashbard</a>
                        </li>
                        <li>
        ...
        <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            <ul className="space-y-2">
                <li>
                    ...
                    <RiDashboardFill className="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
                    <span className="ml-3">Tableau de bord</span>
                    </a>
                </li>
                <Link to="/UsersUI">
                    <a href="#" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    <CiUser className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
                ...
                <li>
                    <a href="#" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    <FiPackage className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
                    <span className="flex-1 ml-3 whitespace-nowrap">Colis</span>
                    </a>
                </li>
                <li>
                    <a href="#" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    <TbFileInvoice className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"/>
                    <span className="flex-1 ml-3 whitespace-nowrap">Factures</span>
                    </a>
                </li>
                <li>
                    <a href="#" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    <BsDatabaseCheck className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"/>
            ...
            <div className="grid grid-cols-3 gap-4 mb-4">
                <div className="text-center items-center justify-center h-30 rounded bg-gray-50 dark:bg-gray-800">
                    ...
                    <GrStatusGood className="text-lg"/>
                        <span className="flex justify-center text-sm text-gray-600 dark:text-gray-400">À EMBALLER</span>
                    </div>
                </div>
                <div className="text-center items-center justify-center h-30 rounded bg-gray-50 dark:bg-gray-800">
                    ...
                    <GoPackage className="text-lg"/>
                        <span className="flex justify-center text-sm text-gray-600 dark:text-gray-400">À EXPEDIER</span>
                    </div>
                </div>
                <div className="text-center items-center justify-center h-30 rounded bg-gray-50 dark:bg-gray-800">
                    <h2 className="text-3xl pt-2 font-semibold text-red-600 dark:text-gray-400">13</h2>
